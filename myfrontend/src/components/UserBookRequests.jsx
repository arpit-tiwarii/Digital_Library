    ...
    <div className="container mt-4">
      <div className="row">
        <div className="col-12">
          <h2 className="mb-4">My Book Requests</h2>
              ...
              {requests.map((request) => (
                <div key={request.requestId} className="col-md-6 col-lg-4 mb-4">
                  <div className="card h-100 shadow-sm">
                       ...
                       alt={`Cover of ${request.book?.bookTitle}`}
                       style={{ height: "200px", objectFit: "cover" }}
                       onError={(e) => { e.currentTarget.src = `${import.meta.env.VITE_API_BASE || 'https://digital-library-backend-clf5.onrender.com'}/images/upload/defaultBook.jpg` }}
                     />
